...
public class Main {
    ...
    //각각의 말 위치 관리 Map, List를 가지고 있어 해당 말에 올려진 말까지 관리
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < K; i++) {
            ...
            Piece piece = new Piece(i + 1, x, y, dir);
            queue.offer(piece);
    ...
    private static void move(PriorityQueue<Piece> queue, Queue<Piece> nextQ, Piece piece, int x, int y) {
        ...
        if (map[x][y] == 0) { //흰
            ...
            if (list != null) {
                ...
                // 현재 노드보다 뒤집었을 때 뒤 노드가 더 늦게 움직이는 말이라면 현재 턴에 움직이도록 해야함.
